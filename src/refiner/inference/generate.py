...
def generate(
    *,
    ...
    return build_inference_map(
        ...
        default_params_arg="default_generation_params",
        max_concurrent_requests=max_concurrent_requests,
        client_call=_generate,
        response_hook=_record_generation_usage,
    )
...
def _record_generation_usage(row: Row, response: Any) -> None:
